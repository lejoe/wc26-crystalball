...
export const FIXTURES: Record<GroupLetter, Fixture[]> = {
  ...
  G: [
    ...
    F('2026-06-26T20:00:00-07:00', 'Egypt', 'Iran', 1, 1),
    F('2026-06-26T20:00:00-07:00', 'New Zealand', 'Belgium', 1, 5),
  ],
  H: [
    ...
    F('2026-06-26T19:00:00-05:00', 'Cabo Verde', 'Saudi Arabia', 0, 0),
    F('2026-06-26T18:00:00-06:00', 'Uruguay', 'Spain', 0, 1),
  ],
  I: [
    ...
    F('2026-06-26T15:00:00-04:00', 'Norway', 'France', 1, 4),
    F('2026-06-26T15:00:00-04:00', 'Senegal', 'Iraq', 5, 0),
  ],
  J: [
    ...
    F('2026-06-27T21:00:00-05:00', 'Algeria', 'Austria', 3, 3),
    F('2026-06-27T21:00:00-05:00', 'Jordan', 'Argentina', 1, 3),
  ],
  K: [
    ...
    F('2026-06-27T19:30:00-04:00', 'Colombia', 'Portugal', 0, 0),
    F('2026-06-27T19:30:00-04:00', 'Congo DR', 'Uzbekistan', 3, 1),
  ],
  L: [
    ...
    F('2026-06-27T17:00:00-04:00', 'Panama', 'England', 0, 2),
    F('2026-06-27T17:00:00-04:00', 'Croatia', 'Ghana', 2, 1),
  ],
}
