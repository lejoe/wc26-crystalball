...
export const FIXTURES: Record<GroupLetter, Fixture[]> = {
  A: [
    ...
    F('2026-06-24', 'Czechia', 'Mexico'),
    F('2026-06-24', 'South Africa', 'Korea Republic'),
  ],
  B: [
    ...
    F('2026-06-24', 'Switzerland', 'Canada'),
    F('2026-06-24', 'Bosnia and Herzegovina', 'Qatar'),
  ],
  C: [
    ...
    F('2026-06-24', 'Scotland', 'Brazil'),
    F('2026-06-24', 'Morocco', 'Haiti'),
  ],
  D: [
  ...
  I: [
    ...
    F('2026-06-22', 'France', 'Iraq'),
    F('2026-06-22', 'Norway', 'Senegal'),
  ...
  J: [
    ...
    F('2026-06-22', 'Argentina', 'Austria'),
    F('2026-06-22', 'Jordan', 'Algeria'),
  ...
  K: [
    ...
    F('2026-06-23', 'Portugal', 'Uzbekistan'),
    F('2026-06-23', 'Colombia', 'Congo DR'),
  ...
  L: [
    ...
    F('2026-06-23', 'England', 'Ghana'),
    F('2026-06-23', 'Panama', 'Croatia'),
